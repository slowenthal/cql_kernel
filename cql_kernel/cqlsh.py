...
CASSANDRA_PATH = os.path.dirname(os.path.realpath(__file__))   # For cql_kernel
...
from cqlshlib_cql_kernel import cql3handling, cqlhandling, pylexotron, sslhandling
from cqlshlib_cql_kernel.copyutil import ExportTask, ImportTask
from cqlshlib_cql_kernel.displaying import (ANSI_RESET, BLUE, COLUMN_NAME_COLORS, CYAN,
                                 RED, FormattedValue, colorme)
from cqlshlib_cql_kernel.formatting import (DEFAULT_DATE_FORMAT, DEFAULT_NANOTIME_FORMAT,
